...
const getMailIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 12" className="bi bi-envelope" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getAtIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 12" className="bi bi-at" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
